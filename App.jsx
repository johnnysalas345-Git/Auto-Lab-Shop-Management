                      ...
                      <React.Fragment key={customer.id}>
                        {custVehicles.length === 0 ? (
                          <tr style={{ borderBottom: '1px solid', borderColor: COLORS.border }}>
                            <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', cursor: 'pointer' }} onClick={() => setEditingCustomer(customer)} title="Click to edit">{customer.data?.name}</td>
                            <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', cursor: 'pointer' }} onClick={() => setEditingCustomer(customer)} title="Click to edit">{customer.data?.phone}</td>
                          ...
                          custVehicles.map((vehicle, idx) => (
                            <tr key={vehicle.id} style={{ borderBottom: '1px solid', borderColor: COLORS.border }}>
                              <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', cursor: 'pointer' }} onClick={() => setEditingCustomer(customer)} title="Click to edit">{idx === 0 ? customer.data?.name : ''}</td>
                              <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', cursor: 'pointer' }} onClick={() => setEditingCustomer(customer)} title="Click to edit">{idx === 0 ? customer.data?.phone : ''}</td>
                              <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', textAlign: 'center', cursor: 'pointer' }} onClick={() => setEditingVehicle(vehicle)} title="Click to edit">{vehicle.data?.make}</td>
                              <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.text, fontWeight: '700', textAlign: 'center', cursor: 'pointer' }} onClick={() => setEditingVehicle(vehicle)} title="Click to edit">{vehicle.data?.model}</td>
                              <td style={{ padding: '12px 16px', fontSize: 15, color: COLORS.primary, fontWeight: '800', textAlign: 'center', cursor: 'pointer' }} onClick={() => setEditingVehicle(vehicle)} title="Click to edit">{vehicle.data?.license_plate}</td>
                              <td style={{ padding: '12px 16px', textAlign: 'center' }}>
